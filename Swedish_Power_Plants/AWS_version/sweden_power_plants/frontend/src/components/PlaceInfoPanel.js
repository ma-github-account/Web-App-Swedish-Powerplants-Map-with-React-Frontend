...
// Bundled with the app rather than fetched from MEDIA_URL: these are UI
// fallbacks, not uploaded content, and media now lives in S3 - a hardcoded
// /images/... path would 404 the moment MEDIA_URL points off-site.
import FALLBACK_IMAGE from '../assets/sweden.png'
